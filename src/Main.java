...
import transformations.LinearDiscriminantAnalysis;
...
public class Main {
	...
	public static void main(String[] args) 
	{
		...
		{
		case 0: transformation	= new StarCordinates(); break;
		case 1: transformation	= new LinearDiscriminantAnalysis(); break;
		case 2: transformation	= new PrincipalComponentAnalysis(); break;
		case 3: transformation	= new MultidimensionalScaling(); break;
		default: transformation	= new StarCordinates();
		}
